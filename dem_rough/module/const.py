...
NET = network.RoughConv3(beta=BETA, spike_grad=SPIKE_GRAD, device=DEVICE, input_height=SPLITED_INPUT_HEIGHT, input_width=SPLITED_INPUT_WIDTH, rough_pixel=3, parm_learn=PARM_LEARN, input_channel=INPUT_CHANNEL, power=True, reset=RESET, )
