...
if __name__ == "__main__":
    dem_path_abs = bpy.path.abspath(DEM_ONLY_BOULDER_PATH_BLENDER) # https://twitter.com/Bookyakuno/status/1457726187745153038
    video_path_abs = bpy.path.abspath(VIDEO_ONLY_BOULDER_PATH_BLENDER)
    print(dem_path_abs)
