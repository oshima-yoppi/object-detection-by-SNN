...
copy_dir = "../dem_stereo/dataset/100000_(130,173)_th-0.15_MaxStep-10_EventCount-False_Distinguish-True_LeargeData-True"
copy_paths = os.listdir(copy_dir)
for i, (moto_path, copy_path) in enumerate(zip(tqdm(moto_paths), copy_paths)):
