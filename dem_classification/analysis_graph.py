...
plt.plot(event_th, precision, label="Precision", linestyle="solid", marker="x", color="red")
plt.plot(event_th, recall, label="Recall", linestyle="solid", marker="x", color="blue")
plt.plot(event_th, accuracy, label="Accuracy", linestyle="solid", marker="x", color="green")
plt.legend()
plt.show()
# %%
