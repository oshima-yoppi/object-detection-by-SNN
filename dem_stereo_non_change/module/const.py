...
MODEL_NAME = f"{NETWORK_CLASS_NAME}_{ACCUMULATE_EVENT_MICROTIME}_th-{0.15}_beta-{1.0}_thresh-{1.0}_BetaLearn-{BETA_LEARN}_thLearn-{THRESHOLD_LEARN}_RepeatInput-{REPEAT_INPUT}_TimeAwareLoss-{TIME_AWARE_LOSS}_TimeChange-{TIME_CHANGE}_step-(6,6)"
