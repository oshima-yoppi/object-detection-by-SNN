...
plt.savefig(os.path.join(SAVE_DIR, f"noisy_thresh_time_iou.png"))
plt.savefig(os.path.join(SAVE_DIR, f"noisy_thresh_time_iou.pdf"))
plt.show()
plt.close()
...
plt.savefig(os.path.join(SAVE_DIR, f"noisy_thresh_time_precision.png"))
plt.savefig(os.path.join(SAVE_DIR, f"noisy_thresh_time_precision.pdf"))
plt.show()
plt.close()
...
plt.savefig(os.path.join(SAVE_DIR, f"noisy_thresh_time_recall.png"))
plt.savefig(os.path.join(SAVE_DIR, f"noisy_thresh_time_recall.pdf"))
plt.show()
plt.close()
...
plt.savefig(os.path.join(SAVE_DIR, f"noisy_thresh_time_fmeasure.png"))
plt.savefig(os.path.join(SAVE_DIR, f"noisy_thresh_time_fmeasure.pdf"))
plt.show()
plt.close()
